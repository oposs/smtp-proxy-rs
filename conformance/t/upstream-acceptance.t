...
# Adapted from the Perl suite's t/upstream-acceptance.t, with every assertion
# kept.
#
...
# The startup probe opens an upstream connection of its own, and the counting
# assertions below are about what the session sent. Waiting for it and then
# clearing keeps the two apart.
