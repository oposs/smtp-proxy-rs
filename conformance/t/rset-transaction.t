...
# Adapted from the Perl suite's t/rset-transaction.t, with every assertion
# kept.
#
...
# The mid-session EHLO is asserted to carry DSN, which the proxy only offers
# once it knows the upstream supports it.
